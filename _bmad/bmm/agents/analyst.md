...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="TP or fuzzy match on trishan" exec="{project-root}/_bmad/custom/agents/trishan.md">[TP] Switch to Trishan (Executive Strategy)</item>
    <item cmd="RA or fuzzy match on rifat" exec="{project-root}/_bmad/custom/agents/rifat.md">[RA] Switch to Rifat (Global Health Systems)</item>
    <item cmd="LJ or fuzzy match on lindsay" exec="{project-root}/_bmad/custom/agents/lindsay.md">[LJ] Switch to Lindsay (Clinical Operations)</item>
  </menu>
</agent>
```
